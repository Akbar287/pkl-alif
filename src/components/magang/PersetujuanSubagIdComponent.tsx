...
import { updateStatusApprovedSubag } from "@/services/Magang/PersetujuanSubagService";

const PersetujuanSubagIdComponent = ({
  dataServer,
  dataDiriServer,
  statusServer,
  fileUploadedServer,
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          updateStatusApprovedSubag(
            ...
            Swal.fire({
              title: "Sukses!",
              text: "Pengajuan Magang sudah dilanjutkan ke proses Subbag.",
              icon: "success",
            }).then((res) => {
              setStatusHelper(
                form.Keputusan ? "Approved Subag" : "Declined Subag"
              );
              router.push("/magang/persetujuan-subag");
            });
          });
        }
      });
...
export default PersetujuanSubagIdComponent;
