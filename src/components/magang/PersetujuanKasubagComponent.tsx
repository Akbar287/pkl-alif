...
import { getPersetujuanKasubagPagination } from "@/services/Magang/PersetujuanKasubagService";

const PersetujuanKasubagComponent = () => {
  const router = useRouter();
  const [dataMagang, setDataMagang] = React.useState<
    PersetujuanKasubagPagination[]
  >([]);
  ...
  const [dataDetail, setDataDetail] =
    React.useState<PersetujuanKasubagPagination | null>(null);

  React.useEffect(() => {
    setLoading(true);
    getPersetujuanKasubagPagination(
  ...
  const columns: ColumnDef<PersetujuanKasubagPagination>[] = [
    {
      accessorKey: "Status",
      header: "Status",
      cell: ({ row }) => (
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={() =>
                  router.push("/magang/persetujuan-kasubag/" + jd.FormasiMhsId)
                }
              >
                Lihat Detail
              </DropdownMenuItem>
...
export default PersetujuanKasubagComponent;
...
function SheetDetailTicket({
  ...
  titleDialog: string;
  loading: boolean;
  dataDetail: PersetujuanKasubagPagination | null;
}) {
  return (
